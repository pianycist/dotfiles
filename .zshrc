...
#POWERLEVEL9K_TIME_FORMAT="HH:MM"
...
export PATH=$HOME/bin:$HOME/.local/bin:/usr/local/bin:$HOME/.gem/ruby/2.6.0/bin:$NPM_CONFIG_PREFIX/bin:$PATH
...
plugins=(history-substring-search vi-mode archlinux pyenv npm colored-man-pages pip tmux node zsh-completions git command-not-found compleat zsh-autosuggestions zsh-syntax-highlighting)
